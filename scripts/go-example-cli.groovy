node {
    ...
    stage('Build') {
        dir('project-examples/golang-example/hello') {
          ...
          export GOPROXY="http://admin:AKCp5ccv3oMbQuovKWLzCdRW2RnZW9Qb4agjxVA931J9SsJwwkEuAe1yknQtMBegJvDq8RSr8@192.168.230.155:8081/artifactory/api/go/go-virtual"
          go build
        }
    }
